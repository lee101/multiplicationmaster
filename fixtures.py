...
EASY_LEVELS = [
    ...
    Level(EASY, 1, 15, 1, 0, 60 * 4, starrating=[192, 232, 272, 312]),
    Level(EASY, 0, 20, 1, 0, 60 * 4, starrating=[192, 232, 272, 312]),
    ...
    Level(EASY, 1, 15, 1, 0, 60 * 4, MINUS_FORMULA, starrating=[192, 232, 272, 312]),
    Level(EASY, 0, 20, 1, 0, 60 * 4, MINUS_FORMULA, starrating=[192, 232, 272, 312]),
    ...
    Level(EASY, 0, 1.6, 0.1, 0, 60 * 4, starrating=[192, 232, 272, 312]),
    Level(EASY, 0, 2.1, 0.1, 0, 60 * 4, starrating=[192, 232, 272, 312]),
    ...
    Level(EASY, -5, 15, 1, 0, 60 * 4, starrating=[192, 232, 272, 312]),
    Level(EASY, -10, 15, 1, 0, 60 * 4, starrating=[192, 232, 272, 312]),
    ...
    Level(EASY, -15, 20, 1, 0, 60 * 4, starrating=[110, 140, 160, 190]),
]
MEDIUM_LEVELS = [
    ...
    Level(MEDIUM, 0, 1.6, 0.1, 0, 60 * 4, MINUS_FORMULA, starrating=[192, 232, 272, 312]),
    Level(MEDIUM, 0, 2.1, 0.1, 0, 60 * 4, MINUS_FORMULA, starrating=[192, 232, 272, 312]),
    ...
    Level(MEDIUM, 1, 20, 1, 0, 60 * 4, TIMES_FORMULA, starrating=[192, 232, 272, 312]),
    Level(MEDIUM, 0, 30, 1, 0, 60 * 4, TIMES_FORMULA, starrating=[192, 232, 272, 312]),
    ...
    Level(MEDIUM, -1, 1.6, 0.1, 0, 60 * 4, starrating=[192, 232, 272, 312]),
    Level(MEDIUM, -1.5, 2.1, 0.1, 0, 60 * 4, starrating=[192, 232, 272, 312]),
    ...
    Level(MEDIUM, -1, 1.6, 0.1, 0, 60 * 4, MINUS_FORMULA, starrating=[192, 232, 272, 312]),
    Level(MEDIUM, -1.5, 2.1, 0.1, 0, 60 * 4, MINUS_FORMULA, starrating=[192, 232, 272, 312]),
    ...
    Level(MEDIUM, -2, 2.6, 0.1, 0, 60 * 4, MINUS_FORMULA, starrating=[120, 160, 180, 210]),
]
...
HARD_LEVELS = [
    ...
    Level(HARD, 0, 2.6, 0.1, 0, 60 * 4, TIMES_FORMULA, starrating=[192, 232, 272, 312]),
    Level(HARD, 0, 3.1, 0.1, 0, 60 * 4, TIMES_FORMULA, starrating=[192, 232, 272, 312]),
    ...
    Level(HARD, 1, 20, 1, 0, 60 * 4, DIVIDE_FORMULA, starrating=[192, 232, 272, 312]),
    Level(HARD, 0, 30, 1, 0, 60 * 4, DIVIDE_FORMULA, starrating=[192, 232, 272, 312]),
    ...
    Level(HARD, -1, 1.6, 0.1, 0, 60 * 4, TIMES_FORMULA, starrating=[192, 232, 272, 312]),
    Level(HARD, -1.5, 2.1, 0.1, 0, 60 * 4, TIMES_FORMULA, starrating=[192, 232, 272, 312]),
    ...
    Level(HARD, 0, 3.1, 0.1, 15, 0, TIMES_FORMULA, starrating=[170, 200, 240, 260]),
    Level(HARD, 0, 3.1, 0.1, 0, 60 * 4, DIVIDE_FORMULA, starrating=[170, 200, 240, 260]),

]

EXPERT_LEVELS=[

    Level(EXPERT, 2, 99, 1, 0, 60 * 4),
    # -0.1*-0.1
    ...
    Level(EXPERT, -1, 3.6, 0.1,   0, 60 * 4, TIMES_FORMULA, starrating=[192, 232, 272, 312]),
    Level(EXPERT, -1.5, 4.1, 0.1, 0, 60 * 4, TIMES_FORMULA, starrating=[192, 232, 272, 312]),
    Level(EXPERT, -2, 4.6, 0.1,   15, 0, TIMES_FORMULA, starrating=[190, 220, 260, 280]),


    Level(EXPERT, 2, 99, 1, 0, 60 * 4, MINUS_FORMULA),
    ...
    Level(EXPERT, -30, 30, 1, 0, 60 * 4, DIVIDE_FORMULA, starrating=[192, 232, 272, 312]),
    Level(EXPERT, -40, 40, 1, 0, 60 * 4, DIVIDE_FORMULA, starrating=[192, 232, 272, 312]),
    Level(EXPERT, -50, 50, 1, 15, 0, DIVIDE_FORMULA, starrating=[190, 220, 260, 280]),


    Level(EXPERT, 2, 99, 1, 0, 60 * 4, TIMES_FORMULA),
    ...
    Level(EXPERT, -1, 1.6, 0.1,  0, 60 * 4, DIVIDE_FORMULA, starrating=[192, 232, 272, 312]),
    Level(EXPERT, -1.5, 2.1, 0.1, 0, 60 * 4, DIVIDE_FORMULA, starrating=[192, 232, 272, 312]),
    Level(EXPERT, -2, 2.1, 0.1,  15, 0, DIVIDE_FORMULA, starrating=[190, 220, 260, 280]),


    Level(EXPERT, 2, 99, 1, 0, 60 * 4, DIVIDE_FORMULA),
